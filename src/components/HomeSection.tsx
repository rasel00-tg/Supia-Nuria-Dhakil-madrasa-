                    ...
                    <div className="w-full px-2 py-12 space-y-16">
                      ...
                      >
                        ...
                        <div className="text-center w-full space-y-1.5 sm:space-y-3 relative z-10 font-alinur font-sans">
                          <h2 className="text-[17px] xs:text-xl sm:text-4xl font-black text-amber-400 tracking-tight leading-none whitespace-nowrap" style={{ fontFamily: "Ador Noirit, sans-serif" }}>
                            মাদ্রাসা পরিচালনা কমিটির সদস্যবৃন্দ
                          </h2>
                          <p className="text-[11px] sm:text-base text-emerald-100 font-semibold max-w-2xl mx-auto leading-normal font-sans" style={{ fontFamily: "Ador Noirit, sans-serif" }}>
                      ...
                      {/* Custom Premium Form Success Popup (Ador Noirit font) */}
                      <AnimatePresence>
                        {showSuccessPopup && (
                      ...
                      {/* Custom Form Warning Popup (Ador Noirit font) */}
                      <AnimatePresence>
                        {showWarningPopup && (
